...
| `0004-map-schema-freeze.md` | Map-schema freeze (v2 maps + cross-boundary structs) | **MER-34** | **Reserved — not yet written** | The 0004 slot is **reserved for MER-34** (Phase-1 exit gate). No other ADR may claim 0004; this reservation removes the ambiguity MER-41 was filed against. |
...
**Next free ADR number: `0007`.** `0004` is *reserved* (MER-34), not free;
