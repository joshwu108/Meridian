...
| [0004](0004-map-schema-freeze.md) | Map-schema freeze (v2 maps + cross-boundary structs) | **MER-34** | **Reserved — not yet written** | Stub reserved by **MER-41** for the Phase-1 exit gate. No other ADR may claim 0004; MER-34 authors the full decision when upstream gates are green. |
